...
func Init() *Initialize {
	...
	roomServiceImpl := service.RoomServiceInit(roomRepositoryImpl, addressRepositoryImpl, borrowedItemRepositoryImpl, serviceRepositoryImpl, geographyRepositoryImpl, userRepositoryImpl)
